...
const examples = {
    ...
    sendCode: {
        method: 'POST',
        url: 'http://localhost:5001/api/messages/send-code',
        headers: {
        ...
        description: 'Envoyer un code de vérification'
    },
...
console.log('3. Envoyer un code:');
console.log('curl -X POST http://localhost:5001/api/messages/send-code \\');
console.log('  -H "Content-Type: application/json" \\');
console.log('  -d \'{"code":"123456","phoneNumber":"22996762103@c.us"}\'');
console.log('');
